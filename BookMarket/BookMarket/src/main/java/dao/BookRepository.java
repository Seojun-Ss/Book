...
public class BookRepository {
	...
	public BookRepository() {
		...
		book2.setAuthor("송미영");
		book2.setDescription("자바를 처음 배우는 학생을 위해 자바의 기본 개념과 실습 예제를 이용하여 쉽게 설명합니다. 자바의 이론적 개념->기본 예제->프로젝트 순으로 단계별 학습이 가능하며, 각 챕터의 프로젝트를 실습하면서 온라인 서점을 완성할 수 있도록 구성하였습니다.");
